...
import datetime
import time
from hsi_setup_noiseunknow_ratio import Engine, train_options, make_dataset
...
if __name__ == '__main__':
    ...
    # train_dataset = DataLoaderTrainNoiseUnKnownOfflineMultiRatioRelease(basefolder,50,img_options=img_options,use2d=engine.get_net().use_2dconv,repeat=opt.repeat)
    train_dataset = DataLoaderTrainNoiseUnKnownOnlineMultiRatioRelease(basefolder,[20,50,100],img_options=img_options,use2d=engine.get_net().use_2dconv,repeat=opt.repeat)
