...
def sert_real_channel25():
    net = SERT(inp_channels=25,dim = 96,         window_sizes=[16,16,16] ,        depths=[6,6,6],down_rank=8,         num_heads=[ 6,6,6],split_sizes=[1,2,4],mlp_ratio=2,memory_blocks=64)
...
def volformer_48_real():
    net = VolFormer(n_subs=8, n_ovls=2, n_colors=34, n_blocks=3, n_feats=48, res_scale=0.1)
    net.use_2dconv = True
    net.bandwise = False
    return net
